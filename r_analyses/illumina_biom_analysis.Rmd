...
The following columns then show all the taxonomic information brokendown
by different taxa levels:
...
-   Remove species with under 10 reads, which will speed up calculations
    and likely make our results more meaningful since these
...
nmds <- sam_plot %>% 
    ...
    ordinate(method = "NMDS", distance = "bray", trymax = 50)
p_ord <- plot_ordination(sam_plot, nmds,

...
We will work with [.biom files](https://biom-format.org/), acquired froma CZID analysis of our data.
...
#### Formatting column names into snakemake
...
variables unchanged. It is convinient to standardize all variable names
...
number of points like this. I therefore turned off the plotting of
outliers in the boxplot layer.

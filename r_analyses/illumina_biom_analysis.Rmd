...
**QUESTION: How to sort bar plots properly. Also make it looker nicer
obv.**
...
pipeline. FOr this we first subsample to larger samples \>10000 and
...
First we want to filter out some samples and taxa prior to doing some
downstream analysis.

First we remove all samples with very low read counts, here defined as
under 1000 reads. We would thus exclude all controls and the Ceres
filtered sample.

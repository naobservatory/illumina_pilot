...
-   Remove species with under 10 reads, and those occurring in fewer
    than 2 samples, which will speed up calculations and likely make our
    results more meaningful since these identifications can easily be
    spurious.
...
Let's add the Shannon index to a copy of the sample data called
`ps_subset`

...
Now we can add add the Shannon index to a copy of the sample data called
`ps_subset`
...
exponentiation of the Shannon index
...
p_div <- ps_subset %>% 
  ...
  labs(x = 'Experiment Class', y = 'Effective Number of Species') +
  theme(

...
<<<<<<< HEAD
<<<<<<< HEAD
-   DONE - Turn pipeline plot into line plot, without faceting
=======
...
>>>>>>> dff2c5705fc556896a813addcd45530b6b69e21b

    -   TODO - Integrate this: `expand_limits(y = c(0,3e06))`

-   DONE - Fix labeling issues

-   DONE - Use factors to change order in categorical data - relevant
    for sorting bar plots along different categories, such as
    `experiment_class`
...
-   DONE - Drop the step of calculating abundances in an arduous way,
    instead working with tax_glom
...
) %>% ggplot(aes(x = total_reads, y = sample_name)) +
  geom_col(fill = "darkblue") +
  theme_cowplot() +
  xlab("Reads per Sample") +
  ylab("Sample Name") +
  scale_x_continuous(labels = scales::comma, limits = c(0,3.5e6))
```

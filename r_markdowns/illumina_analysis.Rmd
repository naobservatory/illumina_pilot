...
-   Fix `experiment_class` assignment + reactivate code including the
    former.
...
```{r}
sample_pipeline <- read.csv (path(biom_data_path, "2022_12_01_czid_sample_overview.csv"), header = TRUE)

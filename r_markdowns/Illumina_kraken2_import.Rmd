...
We originally thought of **three different ways** of linking viruses persent in the kraken2 reports with the ICTV table:
...
add_species_genome_comp <- function(sample_report_line) {
  ...
  {
    #If the species matches `species` in taxonomy reference, we add the respective genome composition information to the sample_report_line
  ...
  {
      #If the species matches `virus_name_s` in taxonomy reference, we add the respective genome composition information to the sample_report_line
      create_gen_comp_records_on_species(species)

  }
  else if (sample_report_line$genus %in% taxonomy_reference_split_genome_comp$genus)
  {
      #If the genus matches `genus` in taxonomy reference, we add the respective genome composition information to the sample_report_line
